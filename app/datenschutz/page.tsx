      ...
      <section className="section-space pt-12">
        <div className="container-shell max-w-4xl">
          <article className="surface space-y-9 p-7 text-sm leading-7 text-[#9da3a8] md:p-10">
            ...
            <section><h2 className="text-xl font-semibold text-white">2. Zwecke und Rechtsgrundlagen</h2><p className="mt-3">Wir verarbeiten Daten, um Anmeldung und Kontoverknüpfung, Serverzugang, Regelbestätigungen, Support-Tickets, Rollen und Berechtigungen, Teamaktivität, Kalender, interne Dokumente, Missbrauchsschutz, Protokollierung sowie den sicheren Betrieb des Portals bereitzustellen. Soweit die DSGVO gilt, stützen wir dies je nach Vorgang auf Vertrag bzw. vorvertragliche Maßnahmen, berechtigte Interessen an einem sicheren Communitybetrieb und gegebenenfalls Einwilligung.</p></section>
            <section><h2 className="text-xl font-semibold text-white">3. Anmeldung, Cookies und Profile</h2><p className="mt-3">Auth.js setzt technisch notwendige, mit HttpOnly geschützte Sitzungs-, OAuth-State- und PKCE-Cookies. Discord liefert über „identify“ ID, Benutzername, Anzeigename und Avatar. Roblox liefert über „openid profile“ ID, Benutzername, Anzeigename und Profilbild. Passwörter und E-Mail-Adressen werden nicht angefordert. Profildaten werden bei Anmeldung, manueller Aktualisierung oder Discord-Bot-Abgleich erneuert.</p></section>
            <section><h2 className="text-xl font-semibold text-white">4. Weitere Daten und Integrationen</h2><p className="mt-3">Gespeichert werden Ticketinhalte und Nachrichten, Regelbestätigungen, Rollen und deren Quellen, redaktionelle Inhalte, Kalendertermine, interne Dokumente, Medienmetadaten, öffentliche Statusmeldungen sowie Audit-Logs privilegierter Aktionen. Der Discord-Bot kann Mitglieder-, Rollen- und Synchronisierungsdaten über geschützte Endpunkte übertragen und bestätigte Strike- oder Up-Rank-Sperrrollen verarbeiten. Die Melonly-API liefert Teamrollen, Mitgliedskennungen, Schichten und genehmigte Abwesenheiten zur Wochenauswertung. ER:LC wird serverseitig für Status- und Betriebsdaten ausgelesen.</p></section>
            <section><h2 className="text-xl font-semibold text-white">5. Empfänger und Auftragsverarbeiter</h2><p className="mt-3">Für Hosting und PostgreSQL-Datenbank nutzen wir Railway, für Medien Cloudinary, für Teamaktivität Melonly sowie für die Authentifizierung Discord und Roblox. Je nach Anbieter können technische Daten wie IP-Adresse, Browserinformationen, Zeitstempel und angeforderte URL verarbeitet werden. Interne Cloudinary-Dateien werden nur über kurzzeitig signierte Links ausgeliefert.</p></section>
            <section><h2 className="text-xl font-semibold text-white">6. Auslandübermittlungen</h2><p className="mt-3">Railway, Discord, Roblox, Melonly und Cloudinary können Daten außerhalb der Schweiz oder des EWR, insbesondere in den USA oder im Vereinigten Königreich, verarbeiten. Übermittlungen erfolgen nach den jeweils anwendbaren gesetzlichen Garantien der Anbieter, etwa Angemessenheitsbeschlüssen oder Standardvertragsklauseln. Weitere Informationen enthalten die Datenschutzhinweise der jeweiligen Anbieter.</p></section>
