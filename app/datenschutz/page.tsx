    ...
    <>
      ...
      <section className="section-space">
        <div className="container-shell max-w-3xl surface p-8 prose-copy">
          ...
          <p className="mt-3">Die Daten dienen der Kontoverwaltung, Bearbeitung von Support-Tickets und Kontoverknüpfungen sowie der sicheren Administration des Servers.</p>
